...
export default function Contact() {
  return (
    <div className="flex-grow flex flex-col md:flex-row w-full max-w-[1440px] mx-auto min-h-[calc(100vh-100px)]">
      ...
      <div className="w-full md:w-5/12 px-margin-mobile md:px-margin-desktop py-24 md:py-32 bg-zinc-900/40 backdrop-blur-2xl border-r border-white/10 shadow-[inset_-1px_0_0_rgba(255,255,255,0.1),20px_0_40px_-15px_rgba(0,0,0,0.5)] transition-all duration-500 ease-out hover:bg-zinc-900/50 flex flex-col justify-between">
        <div>
